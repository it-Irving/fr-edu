...
import com.ljw.eduservice.client.impl.UcenterFileDegradeFeignClient;
 ...
 * @author Luo
 */
@FeignClient(name = "service-ucenter", fallback = UcenterFileDegradeFeignClient.class) // 用于指定从哪个服务中调用功能 ,名称与被调用的服务名保持一致
@Component
